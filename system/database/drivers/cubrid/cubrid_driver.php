...
class CI_DB_cubrid_driver extends CI_DB {
	...
	// Default CUBRID Broker port. Will be used unless users
	...
	function db_connect()
	{
		...
		if ($conn)
		{
			// Check if a users wants to run queries in dry, i.e. run the
	...
	function _escape_identifiers($item)
	{
		...
		foreach ($this->_reserved_identifiers as $id)
		{
			if (strpos($item, '.'.$id) !== FALSE)
			{
				...
				// remove duplicates if the users already included the escape
